...
# ACCOUNT_USER_MODEL_USERNAME_FIELD = 'username' # Userモデルにusernameは無い
# ACCOUNT_EMAIL_REQUIRED = True # メールアドレスを要求する
# ACCOUNT_USERNAME_REQUIRED = True # ユーザー名を要求しない

LOGIN_URL = 'app:login'
LOGIN_REDIRECT_URL = 'app:top'
# LOGOUT_URL = 'app:logout'
# LogoutViewのtemplate_nameで定義したため、LOGOUT_REDIRECT_URLは不要
